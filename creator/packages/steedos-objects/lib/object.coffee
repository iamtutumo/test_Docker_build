clone = require('clone');
Creator.objectsByName = {}   #  This object can only be called after ensuring that all Objects have been initialized, otherwise the obtained objects will be incomplete.
...
Creator.Object = (options)->
	...
	self.related_objects = Creator.getObjectRelateds(self.name)
	 ...
	 # Let all objects have all by defaultlist_views/actions/related_objects/readable_fields/editable_fields完整权限，该权限可能被数据库中设置的admin/user权限覆盖
