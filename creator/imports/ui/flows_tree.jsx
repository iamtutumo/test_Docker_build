...
export function getNodeItemLabel(item, flowLabelClick) {
 ...
 //Button control must be used here, otherwise it will cause search. After expansion by default, the click event will not be triggered when clicked for the first time.	return (
		<div>
			<Button
