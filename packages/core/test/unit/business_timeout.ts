...
const holidays:Array<Holiday> = [{
    name: 'The first day of National Day',
    type: 'public',
    date: new Date("2020-10-01T00:00:00.000Z")
},
{
    name: 'The second day of National Day',
    type: 'public',
    date: new Date("2020-10-02T00:00:00.000Z")
},
{
    name: 'The third day of National Day',
    type: 'public',
    date: new Date("2020-10-03T00:00:00.000Z")
},
{
    name: 'The fourth day of National Day',
    type: 'public',
    date: new Date("2020-10-04T00:00:00.000Z")
},
{
    name: 'The fifth day of National Day',
    type: 'public',
    date: new Date("2020-10-05T00:00:00.000Z")
},
{
    name: 'The sixth day of National Day',
    type: 'public',
    date: new Date("2020-10-06T00:00:00.000Z")
},
{
    name: 'The seventh day of National Day',
    type: 'public',
    date: new Date("2020-10-07T00:00:00.000Z")
},
{
    name: 'The 8th day of National Day',
    type: 'public',
    date: new Date("2020-10-08T00:00:00.000Z")
},
{
    name: 'Regular make-up shifts on Saturdays after National Day',
    type: 'adjusted_working_day',
    date: new Date("2020-10-10T00:00:00.000Z"),
    adjusted_to: '4'
},
{
    name: 'Extra Friday after the National Day holiday',
    type: 'adjusted_holiday',
    date: new Date("2020-10-09T00:00:00.000Z")
},
{
    name: 'Extra Sunday shifts after National Day',
    type: 'adjusted_working_day',
    date: new Date("2020-10-11T00:00:00.000Z"),
    adjusted_to: '5'
},
{
    name: 'Public holiday on Wednesday, August 12th',
    type: 'public',
    date: new Date("2020-08-12T00:00:00.000Z"),
    adjusted_to: '3'
},
{
    name: 'Public holiday on Thursday, August 13th',
    type: 'public',
