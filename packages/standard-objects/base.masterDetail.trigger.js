...
// Prohibit synchronization of the sub-table owner value and the main table object that records the owner value in the main table
// There are two effects after prohibition
// 1. No longer synchronize the object's sub-table record owner value to the main table record owner value
// 2. No longer confirm whether you have edit or read-only permissions for the main table record when modifying the sub-table record.
