...
const checkRepeatCompany = function(orgId, spaceId){
    ...
    if (repeatCompany) {
        ...
        throw new Error("The associated organization has been occupied by another branch and cannot be associated with the organization again.");
    }
}
    ...
    "before.remove.server.company": {
        ...
        todo: function (userId, doc) {
            if (doc.organization) {
                ...
                if(org){
                    throw new Meteor.Error(400, "Please clear the associated organization value first and then delete the division.");
                }
            }
        }
    },
...
Creator.Objects['company'].methods = {
    updateOrgs: async function (req, res) {
        ...
        if (!company.organization) {
            throw new Meteor.Error(400, "The associated organization of this division is not set");
        }
