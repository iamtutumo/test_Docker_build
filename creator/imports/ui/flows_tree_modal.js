...
var modalProp = new ReactiveVar({heading: "Selection process"});
...
function getStartFlow(showType){
	...
	var all_flows = [];
	//Do not show starred processes when distributing
	if(listData.distribute_optional_flows){
		return []
	}else{
		//Convert the data structure of process classification into a list of process id values
